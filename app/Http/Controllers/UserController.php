...
class UserController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        User::create($data);
        return redirect('/')->with('succes-register', 'Uspješno ste se registrovali , molimo da se sada ulogujete');
    }
    ...
    public function login(Request $request)
    {
        ...
        if (auth()->attempt([
            ...
            return redirect('/main')->with('succes-login', 'Uspješno ste se ulogovali');
        } else {
